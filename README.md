...
- [badsectorlabs/ludus_elastic_agent](https://github.com/badsectorlabs/ludus_elastic_agent) - An Ansible role that installs an Elastic Agent on a Windows, Debian, or Ubuntu system (3 months ago)
- [cyberbuff/LOAS](https://github.com/cyberbuff/LOAS) - Living off the Orchard: Apple Script  (4 months ago)
- [infosecB/LOOBins](https://github.com/infosecB/LOOBins) - Living Off the Orchard: macOS Binaries (LOOBins) is designed to provide detailed information on various built-in &#34;living off the land&#34; macOS binaries and how they can be used by threat actors for malicious purposes.  (4 months ago)
